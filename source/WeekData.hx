...
class WeekData {
	...
	public static function createWeekFile():WeekFile {
		var weekFile:WeekFile = {
			songs: [["Bopeebo", "dad", [146, 113, 253], "classic"], ["Fresh", "dad", [146, 113, 253], "classic"], ["Dad Battle", "dad", [146, 113, 253], "classic"]],
			weekCharacters: ['dad', 'bf', 'gf'],
			weekBackground: 'stage',
			weekBefore: 'tutorial',
			storyName: Language.g('week_editor_placeholder_title'),
			weekName: Language.g('week_editor_placeholder_name'),
