...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Extra Keys Team'],
			['tposejank', 			'tposejank',		'EK Programmer',			 								'https://twitter.com/tposejank', 		'B9AF27'],
			...
			[''],
			['EK Special Thanks'],
			['Heropowerbrine',		'hero',				'Fan-made Legacy Extra Keys Mobile, fixes & features',		'https://www.youtube.com/c/Heropowerbrine','B9AF27'],
			['Kivers',				'kivers',			'Fan-made Legacy Extra Keys Mobile, fixes & features',		'https://m.youtube.com/channel/UCH9N4SNzwE2XineTLwhDccA','CF2D2D'],
			['Mobile Special Thanks'],
			['MAJigsaw77',			'jigsaw',			'Author of Mobile Controls, Legacy EK Mobile','https://github.com/MAJigsaw77',						'898989'],
