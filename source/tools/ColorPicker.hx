...
class ColorPicker extends MusicBeatSubstate {
    ...
    var color:FlxColor;
    var redNumeric:FlxUINumericStepper;
    var greenNumeric:FlxUINumericStepper;
    var blueNumeric:FlxUINumericStepper;
    ...
    public override function new(color2:FlxColor, callback:FlxColor->Void) {
        ...
        redNumeric = new FlxUINumericStepper(10, 75 + label.height, 1, 0, 0, 255, 0);
        greenNumeric = new FlxUINumericStepper(20 + redNumeric.width, 75 + label.height, 1, 0, 0, 255, 0);
        blueNumeric = new FlxUINumericStepper(30 + greenNumeric.width + redNumeric.width, 75 + label.height, 1, 0, 0, 255, 0);
        redNumeric.value = color.red;
        greenNumeric.value = color.green;
        blueNumeric.value = color.blue;
        tab.add(label);
        ...
        pasteFromClipboard.resize(280, pasteFromClipboard.height);
        ...
        colorSliderThing.loadGraphic(Paths.image(FlxUIAssets.IMG_RETICLE, "shared"));
        colorSliderThing.visible = false;

        colorPickerThing = new FlxUISprite(0, 0);
        colorPickerThing.loadGraphic(Paths.image(FlxUIAssets.IMG_MARKER, "shared"));
