...
class LogsOverlay extends Sprite {
    ...
    public static function error(thing:Dynamic, color:FlxColor = FlxColor.RED) {
        LogsOverlay.trace(thing, color);
        errors++;
    }
	public static function trace(thing2:Dynamic, color:FlxColor = FlxColor.WHITE) {
        var thing = "";
    ...
    public function new() {
        ...
        titleText.text = 'Psych Engine v' + MainMenuState.psychEngineVersion;
